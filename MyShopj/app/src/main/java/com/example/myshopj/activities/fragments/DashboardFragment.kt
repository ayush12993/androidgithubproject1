package com.example.myshopj.activities.fragments
...
import com.example.myshopj.activities.CartListActivity
import com.example.myshopj.activities.ProductDetailsActivity
import com.example.myshopj.activities.SettingsActivity
        ...
        if (dashboardItemsList.size > 0) {
            ...
            adapter.setOnClickListener(object :
                ...
                override fun onClick(position: Int, product: Product) {
                    ...
                    intent.putExtra(Constants.USER_LOCATION,product.location)
